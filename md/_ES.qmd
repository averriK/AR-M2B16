...
-   Para la la definición de las probabilidades anuales de excedencia (períodos de retorno) de los sismos de diseño del sitio del proyecto de jacobina se recomiendan los lineamientos de la norma brasileira ABNT-NBR 13028 @NBR13028 basdadas en las recomendaciones del Canadian Dam Association (CDA) @CDA2014 o las recomendaciones del Global Industry Standard on Tailing Management (GISTM) @GISTM2020
