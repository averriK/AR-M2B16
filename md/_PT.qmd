...
-   Para a definição das probabilidades de excedência anual (períodos de retorno) de terremotos de projeto, são recomendadas as diretrizes da norma brasileira ABNT-NBR 13028 @NBR13028 baseadas nas recomendações da Canadian Dam Association (CDA) @CDA2014 ou as recomendações da Global Industry Standard on Tailing Management (GISTM) @GISTM2020.
