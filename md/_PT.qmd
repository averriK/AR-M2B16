...
-   Para a definição das probabilidades de excedência anual (períodos de retorno) de terremotos de projeto, são recomendadas as diretrizes da norma brasileira ABNT 13028 baseadas nas recomendações da Canadian Dam Association (CDA) @CDA2014 ou as recomendações da Global Industry Standard on Tailing Management (GISTM) @GISTM2020.

-   Para a definição do terremoto de projeto para as barragens B1 e B2, recomenda-se a realização de um estudo dinâmico de resposta local que estima a amplificação por local dos efeitos do solo de fundação das barragens B1 e B2, com base nos estudos geotécnicos disponíveis O estudo de risco sísmico deve relatar os espectros uniformes de projeto sísmico de risco para diferentes condições geotécnicas de acordo com a ASCE 7-22 @ASCE722
